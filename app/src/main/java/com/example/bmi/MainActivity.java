    ...
    public void calculateBMI(View view) {
        ...
        if (weight_ <= 0 || height_ <= 0) {
            ...
            if (result_ <= 16) {
                ...
                resultText.setText("Ожирение третьей степени.\nТребуется срочное и серьезное медицинское вмешательство. Обратитесь к бариатрическому хирургу и эндокринологу. Бариатрическая операция часто является наиболее эффективным и рекомендованным методом лечения для снижения веса и улучшения здоровья.\nПодход должен быть комплексным. Даже при рассмотрении операции, необходима работа с диетологом, психологом и другими специалистами для подготовки и успешной реабилитации.");
            }
